...
export default function LandingPageSection5Component() {
  ...
  return (
    <div className="bg-light2 px-[20px] py-[64px] md:px-[64px] md:py-[112px] flex flex-col md:flex-row gap-[48px] lg:gap-[80px] items-center justify-between rounded-b-[100px]">
